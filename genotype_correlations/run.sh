...
# Declare prefixes
#declare -a prefixes=("qehq_3" "eipl_1" "letw_1" "sojd_3" "poih_4" "joxm_1")
#declare -a prefixes=("zihe_1" "iisa_3" "uilk_3" "xojn_3")
...
# Output directory
output_dir="/data/abattle4/surya/datasets/for_lakshmi/results-test-new"

# Base directories for g_param and r_param
#g_base_dir="/data/abattle4/lakshmi/cuomo_2020/pipeline_files/gencove_outputs"
#g_base_dir="/data/abattle4/lakshmi/cuomo_2020/pipeline_files/seqtk_outputs"
g_base_dir="/data/abattle4/lakshmi/cuomo_2020/other_rsample_tests/gencove_maxDS_outputs"
r_base_dir="/data/abattle4/lakshmi/cuomo_2020/genotypes"
...
for ((i=0; i<length; i++)); do
    ...
    #echo b_prefix: $b_prefix
    #echo b_param: $b_param
    #echo g_param: $g_param
    #echo r_param: $r_param
