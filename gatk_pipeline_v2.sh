...
usage() {
    ...
    echo "    For FastQ, the files should be named as <sample_name>_1.fastq.gz and"
    echo "    <sample_name>_2.fastq.gz. For CRAM, the file should be named as <sample_name>.cram."
    echo ""
